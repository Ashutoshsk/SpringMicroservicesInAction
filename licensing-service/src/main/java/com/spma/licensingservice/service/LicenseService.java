...
import com.spma.licensingservice.config.ServiceConfig;
...
import com.spma.licensingservice.utils.UserContextHolder;
    ...
    private Organization retrieveOrganizationInfo(String organizationId, String clientType) {
        ...
        switch (clientType) {
            ...
            case "webclient":
                ...
                organization = organizationWebClient.getOrganization(organizationId);
                break;
            default:
                organization = organizationRestClient.getOrganization(organizationId);
                break;
